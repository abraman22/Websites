						...
						<div class="wonderplugin-slider-options-tab wonderplugin-slider-options-tab-selected">
							<table class="wonderplugin-form-table-noborder">
								<tr>
									...
									<br /><label><input name='wonderplugin-slider-pauseonmouseover' type='checkbox' id='wonderplugin-slider-pauseonmouseover' value='' /> Pause the slideshow on mouse over</label>
						...
						<div class="wonderplugin-slider-options-tab">
							...
							<table class="wonderplugin-form-table-noborder">
								...
								<tr id="wonderplugin-slider-confignavimage">
									<th>
									<span id="wonderplugin-slider-confignavbullets-title">Navigation bullets</span>
									<span id="wonderplugin-slider-confignavthumbnails-title">Navigation thumbnails</span>
									<span id="wonderplugin-slider-confignavnumbering-title">Navigation numbers</span></th>
									<td>
										...
										<label><span style="display:inline-block;min-width:100px;">Width:</span> <input name='wonderplugin-slider-navwidth' type='number' class="small-text" id='wonderplugin-slider-navwidth' value='32' /></label>
										<label><span style="display:inline-block;min-width:100px;margin-left:36px;">Height:</span> <input name='wonderplugin-slider-navheight' type='number' class="small-text" id='wonderplugin-slider-navheight' value='32' /></label><br />
										</div>
										...
										<label><span style="display:inline-block;min-width:100px;">Margin X:</span> <input name='wonderplugin-slider-navmarginx' type='number' class="small-text" id='wonderplugin-slider-navmarginx' value='8' /></label>
										<label><span style="display:inline-block;min-width:100px;margin-left:36px;">Margin Y:</span> <input name='wonderplugin-slider-navmarginy' type='number' class="small-text" id='wonderplugin-slider-navmarginy' value='8' /></label>
										<label><span style="display:inline-block;min-width:100px;">Spacing:</span> <input name='wonderplugin-slider-navspacing' type='number' class="small-text" id='wonderplugin-slider-navspacing' value='8' /></label>
										</div>
									</td>
								</tr>
